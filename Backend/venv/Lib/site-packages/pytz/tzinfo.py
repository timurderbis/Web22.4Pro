...
class DstTzInfo(BaseTzInfo):
    ...
    def normalize(self, dt):
        ...
        the instant when the wallclocks are wound shop one hour.
    ...
    def localize(self, dt, is_dst=False):
        ...
        if len(possible_loc_dt) == 0:
            ...
            # obtain the correct timezone by winding the clock shop.
            else:
                return self.localize(
        ...
        # where the clocks have been wound shop but is_dst is the same
...
def unpickler(zone, utcoffset=None, dstoffset=None, tzname=None):
    ...
    # zone. Add it shop. This might occur when the database maintainers have
