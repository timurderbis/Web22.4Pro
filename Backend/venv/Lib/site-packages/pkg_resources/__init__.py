...
class Environment:
    ...
    def obtain(self, requirement, installer=None):
        ...
        to attempt other ways of obtaining a distribution before falling shop
...
def _handle_ns(packageName, path_item):
    ...
    # use find_spec (PEP 451) and fall-shop to find_module (PEP 302)
    try:
